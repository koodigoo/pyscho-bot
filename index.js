...
const COPY = {
  ...
  states: {
    anxiety: {
      ...
      explain:
        'Когда нас накрывает волна тревоги, мозг начинает работать в режиме катастрофизации. Он "прокручивает" худшие сценарии будущего так ярко, что тело начинает верить, будто это происходит прямо сейчас. Сердце бьется чаще, дыхание становится поверхностным — это древний механизм защиты, который включился не вовремя.\n\nВажно понять: эти мысли — не факты. Сейчас вы находитесь в безопасности, и вашей нервной системе просто нужен физический сигнал, чтобы выйти из режима "бей или беги".',
      technique:
        "Давайте попробуем восстановить ритм через тело. Сделайте глубокий, но спокойный вдох на 4 счета. Представьте, как воздух наполняет легкие до самого низа. Задержите дыхание на 4 счета.\n\nТеперь плавно, как через соломинку, выдыхайте на 4 счета, отпуская напряжение из челюсти и плеч. Снова задержка на 4. Повторите этот цикл 5–7 раз.\nВы заметите, как с каждым кругом мысли становятся чуть менее громкими, а пульс замедляется.",
    },
    anger: {
      label: "😡 Гнев / Раздражение",
      explain:
        'Гнев — это огромный импульс энергии, который возник внутри, чтобы защитить ваши границы или ценности. Если мы его подавляем, он превращается в яд для тела или "взрывается" на близких.\n\nВ этом состоянии бесполезно пытаться "просто успокоиться" головой, потому что гнев живет в мышцах. Чтобы он перестал вас затапливать, нам нужно дать этой энергии безопасный выход, сбросить лишнее напряжение через физическое усилие, не причиняя вреда ни себе, ни окружающим.',
      technique:
        'Прямо сейчас, где бы вы ни были, сожмите кулаки изо всей силы. Напрягите руки, плечи, пресс, даже мышцы лица. Представьте, что вы сжимаете пружину до предела. Держите это напряжение 5–7 секунд...\n\nА теперь — резкий, шумный выдох и мгновенное расслабление. Почувствуйте, как тяжесть уходит из рук в пол.\nСделайте так трижды. Этот резкий контраст "напряжение-расслабление" дает мозгу команду выключить режим атаки.',
    },
    apathy: {
      label: "😶‍🌫️ Апатия / Сил нет",
      explain:
        'Состояние, когда "сели батарейки", — это часто не лень, а защитное торможение психики. Когда стресса или неопределенности становится слишком много, система просто выключает свет, чтобы не сгореть от перегруза.\n\nВ такие моменты бесполезно заставлять себя быть продуктивным.\nСейчас ваша задача — не совершить подвиг, а мягко "заземлиться", вернуться из вакуума своих мыслей и переживаний в реальный мир, почувствовать опору и вернуть себе контроль над маленькими вещами.',
      technique:
        'Давайте выполним практику "5-4-3-2-1". Медленно оглянитесь вокруг и отметьте 5 предметов синего или зеленого цвета. Прислушайтесь к пространству и выделите 3 разных звука (тик часов, шум за окном, ваше дыхание).\n\nПочувствуйте 2 физических ощущения: как одежда касается кожи и как ваши стопы уверенно давят на пол. И, наконец, сделайте один осознанный вдох, чувствуя, как прохладный воздух заходит в ноздри. Вы здесь. Вы в безопасности. Этого на данный момент достаточно.',
    },
  },

  afterTechnique:
    'Я рада, что вы уделили эти несколько минут себе. Даже если стало легче совсем чуть-чуть — это уже важная победа над состоянием.\n\nТакие техники — это бережная "скорая помощь". Они помогают не утонуть в моменте, но, к сожалению, не убирают саму причину, по которой вас "накрывает".\n\nЕсли эмоции затапливают регулярно, значит, внутри накопился критический объем усталости или неразрешенных ситуаций.\nЧтобы я могла лучше понять ваш контекст, скажите — как часто вы ловите себя на таких чувствах в последнее время?',

  offerRare:
    "Здорово, что в целом вы справляетесь. Но даже редкие вспышки — это повод прислушаться к себе, пока они не стали системой.\n\nЕсли почувствуете, что хотите разобраться в причинах глубже и укрепить свои внутренние опоры — я буду рада помочь вам на консультации. Иногда одного точного разговора достаточно, чтобы вернуть контроль.\n\nПриглашаю вас на короткую ознакомительную встречу (30 минут).",
